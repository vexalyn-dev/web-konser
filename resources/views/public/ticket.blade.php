        ...
        <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-white dark:bg-slate-800 rounded-2xl border border-slate-200 dark:border-slate-700 shadow-xl overflow-hidden"
                ...
                <div class="p-6 lg:p-8">
                    <!-- Concert Info Banner -->
                    @if($ticket->concert)
                    <div class="bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 p-6 text-white rounded-2xl mb-6">
                        <p class="text-xs font-semibold uppercase tracking-wider text-blue-100 mb-1">Tiket Untuk Konser</p>
                        <h2 class="text-2xl font-bold font-heading mb-3">{{ $ticket->concert->name }}</h2>
                        <div class="flex flex-wrap gap-4 text-sm text-blue-100">
                            <div class="flex items-center gap-2">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/></svg>
                                {{ $ticket->concert->start_date->format('d M Y, H:i') }} WIB
                            </div>
                            <div class="flex items-center gap-2">
