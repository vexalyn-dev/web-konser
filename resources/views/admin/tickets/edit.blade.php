    ...
    <div class="max-w-4xl mx-auto space-y-6">
        ...
        <div data-aos="fade-up">
            <div class="flex items-center gap-3 mb-2">
                ...
                <h1 class="text-2xl font-bold font-heading text-slate-900 dark:text-white">Edit Pemesanan Tiket</h1>
            </div>
            <p class="mt-1 text-slate-500">Kode Tiket: <span
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        <div class="md:col-span-2">
                            ...
                            <select name="concert_id"
                                ...
                                @foreach($concerts as $concert)
                                    <option value="{{ $concert->id }}" {{ old('concert_id', $ticket->concert_id) == $concert->id ? 'selected' : '' }}>
                        ...
                        <div class="md:col-span-2">
                            <label class="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1.5">Nama Lengkap
                                <span class="text-red-500">*</span></label>
                            <input type="text" name="full_name" value="{{ old('full_name', $ticket->full_name) }}"
                        ...
                        <div>
                            ...
                            <input type="email" name="email" value="{{ old('email', $ticket->email) }}"
                        ...
                        <div>
                            <label class="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1.5">Nomor HP
                                <span class="text-red-500">*</span></label>
                            <input type="text" name="phone" value="{{ old('phone', $ticket->phone) }}"
                        ...
                        <div>
                            ...
                            <select name="gender"
                                ...
                                <option value="male" {{ old('gender', $ticket->gender) === 'male' ? 'selected' : '' }}>
                                    Laki-laki</option>
                                <option value="female" {{ old('gender', $ticket->gender) === 'female' ? 'selected' : '' }}>
                                    Perempuan</option>
                            </select>
                        ...
                        <div>
                            ...
                            <input type="date" name="birth_date"
                                value="{{ old('birth_date', $ticket->birth_date->format('Y-m-d')) }}"
                                max="{{ date('Y-m-d') }}"
                        ...
                        <div>
                            ...
                            <input type="text" name="identity_number"
                                value="{{ old('identity_number', $ticket->identity_number) }}"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        <div class="md:col-span-2">
                            ...
                            <textarea name="address" rows="3"
                                class="w-full px-4 py-2.5 rounded-xl border border-slate-200 dark:border-slate-600 bg-white dark:bg-slate-700 text-slate-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent resize-none @error('address') border-red-500 @enderror">{{ old('address', $ticket->address) }}</textarea>
                        ...
                        <div>
                            <label class="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1.5">Kota <span
                                    class="text-red-500">*</span></label>
                            <input type="text" name="city" value="{{ old('city', $ticket->city) }}"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        ...
                        <div>
                            ...
                            <input type="text" name="emergency_phone"
                                value="{{ old('emergency_phone', $ticket->emergency_phone) }}"
